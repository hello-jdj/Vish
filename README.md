...
## Features
- Node-based interface for designing Bash scripts
- Drag-and-drop functionality for creating connections between nodes
- Save and load visual scripts in JSON format
- Export visual scripts to executable Bash scripts
- Customizable node types for various Bash commands

## Screenshots

![Screenshot2](screenshots/screenshot02cd.png)
